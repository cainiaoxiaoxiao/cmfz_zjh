...
<head>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function (data) {
                    $.each(data,function (i,n) {
                        ...
                        var menu="";
                        //控制第二层循环
                        $.each(n.menuList,function (j,m) {
                           // alert(m.url);
                           menu+=" <div style='text-align: center'><a  class='easyui-linkbutton' data-options=\"iconCls:'icon-search',plain:true\" onclick=\"addTabs('" + m.title + "','" + m.url+ "','" + m.iconCis + "')\">" + m.title + "</a></div>";                        })
        ...
        function addTabs(title,url,iconCis) {
           //alert(iconCis);
           // alert(url);
